...
C:\Python314\python.exe scripts\product_retrieval\download_ikea_us_full.py --sample-ratio 0.1 --workers 20
# 全量（较久，数 GB）
C:\Python314\python.exe scripts\product_retrieval\download_ikea_us_full.py --workers 20
# 然后重建索引
